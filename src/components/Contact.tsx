export default function Contact() {
  return (
    <section id="contact" className="py-20 px-4 md:px-8 max-w-4xl mx-auto text-center">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-6">Let's get in touch! Email me at <a href="mailto:prpa.dev@gmail.com" className="text-purple-500 hover:underline">dragan@example.com</a></p>
